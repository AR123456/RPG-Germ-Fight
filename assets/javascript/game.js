...
$(document).ready(function(){
	...
	var characterList= [

		{
			...
			attack: 8,
			counterAttack: 10,
			img:"<img src=\"assets/images/bacteria.png\">"
		},
		{
			id:"germ", 
			Name: "Grand Germ" , 
			...
			attack: 15,
			counterAttack:25,
			img:"<img src='assets/images/germ.png' >"
		},
		{
			id:"macrophage", 
			Name: "Mighty Macrophage" , 
			health:100,
			attack:5,
			counterAttack: 5,  
			img:"<img src='assets/images/macrophage.png' >"
		},
		{
			id:"virus", 
			Name: "Virulent Virus " , 
			...
			attack: 20,
			counterAttack: 25,
			img:"<img src='assets/images/virus.png' >"
		}
	];
...
// display initial character list for selection
	for(var i =0; i < characterList.length; i++){
		...
		button.data('Name', characterList[i].Name);
		...
		button.html(characterList[i].Name + '<br>' + characterList[i].img).append( '<br> <p id="healthTag"> ' + characterList[i].health + '</p>' );
		...
		if(playerSelected==true && enemySelected==true){
			...
			var newAttackCharacter = attackCharacter;
				...
				if(constant == 0 ){
					...
					$('#stats').append("you attacked " + buttonEnemyThis.data('Name') + " for " + buttonPlayerThis.data('attack') + 
						"<br>" + buttonEnemyThis.data('Name') + " attacked you for " + buttonEnemyThis.data('counterAttack')+ " damage.");
...
;						$('.resetButton').show();
					...
					$('#stats').append("you have defeated " + buttonEnemyThis.data('Name') + ", you can choose to fight another enemy." );
